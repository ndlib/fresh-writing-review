...
Essay.create(id: 5, issue_id: issue_id, template: 'media', title: "The Streets Are Art", body: IO.read(Rails.root.join('spec', 'fixtures', 'zavakos_body.txt')), embed: nil, alt_body: nil, alt_title: nil, author: "Rachel Zavakos", works_cited: IO.read(Rails.root.join('spec', 'fixtures', 'zavakos_works_cited.txt')), discussion_questions: IO.read(Rails.root.join('spec', 'fixtures', 'zavakos_discussion_questions.txt')))
