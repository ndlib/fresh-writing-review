...
Issue.delete_all
Issue.create(year: 2014, title: "Fresh Writing Volume 14", editorial_notes: IO.read(Rails.root.join('spec', 'fixtures', 'issues', '2012', 'foreword.md')), editorial_board: IO.read(Rails.root.join('spec', 'fixtures', 'issues', '2012', 'board.md')), acknowledgments: IO.read(Rails.root.join('spec', 'fixtures', 'issues', '2012', 'acknowledgments.md')), cover_image_fixture_path: Rails.root.join('spec', 'fixtures', 'issues', '2012', 'cover.jpg'))
Issue.create(year: 2012, title: "Fresh Writing Volume 12", editorial_notes: IO.read(Rails.root.join('spec', 'fixtures', 'issues', '2012', 'foreword.md')), editorial_board: IO.read(Rails.root.join('spec', 'fixtures', 'issues', '2012', 'board.md')), acknowledgments: IO.read(Rails.root.join('spec', 'fixtures', 'issues', '2012', 'acknowledgments.md')), cover_image_fixture_path: Rails.root.join('spec', 'fixtures', 'issues', '2012', 'cover.jpg'))
Issue.create(year: 2011, title: "Fresh Writing Volume 11", editorial_notes: IO.read(Rails.root.join('spec', 'fixtures', 'issues', '2011', 'foreword.md')), editorial_board: IO.read(Rails.root.join('spec', 'fixtures', 'issues', '2011', 'board.md')), acknowledgments: IO.read(Rails.root.join('spec', 'fixtures', 'issues', '2011', 'acknowledgments.md')), cover_image_fixture_path: Rails.root.join('spec', 'fixtures', 'issues', '2011', 'cover.jpg'))
