...
Essay.delete_all
Essay.create(id: 1, issue_id: issue_id, template: 'text', title: "Family of Deer", author: "Terence Clines",
...
Essay.create(id: 3, issue_id: issue_id, template: 'text', title: "Imperfect, Contradictory Beauty",
...
Essay.create(id: 4, issue_id: issue_id, template: 'media', title: "Invisiball Report", author: "Chizo Ekechukwu",
