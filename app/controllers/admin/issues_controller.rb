class Admin::IssuesController < AdminController
  ...
  def create
    ...
    if @form.save!
      ...
      flash.now[:error] = 'Unable to create the volume.  Please review the error messages below and correct the form.'
      render :new
    end
  end
  ...
  def update
    ...
    if @form.save!
      ...
      flash.new[:error] = 'Unable to update the volume.  Please review the error messages below and correct the form.'
      render :new
    end
  end
  ...
  def save_images
    ...
    if @form.add_images!
      ...
      flash.now[:error] = 'Unable to update the issue image.  Please review the error messages below and correct the form.'
      render :edit_images
    end
  end
