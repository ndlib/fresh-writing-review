...
describe Essay do
  ...
  it "has the essay attributes" do
    ['title', 'body', 'issue', 'embed', 'alt_body', 'alt_title', 'author', 'author_biography', 'works_cited', 'discussion_questions', 'attached_files', 'essay_style', 'essay_award', 'instructor_resources'].each do | attr |
